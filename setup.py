...
#
#     from uftlib import metadata
#
# However, when we do this, we also import `uftlib/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'uftlib_cli = uftlib.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'uftlib_gui = uftlib.gui:entry_point'
        # ]
    }
)
